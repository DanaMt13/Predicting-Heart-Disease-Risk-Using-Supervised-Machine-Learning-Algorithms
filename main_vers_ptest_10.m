...
pTest = 0.1; % Proporția de date pentru testare
...
[XTrain, YTrain, XTest, YTest, XVal, YVal] = buildDatasets2(X, Y, pTest, pVal);
...
% Implicit se folosește bootstrap sampling, valori implicite pentru numărul de predictori și arborii compleți (fără pruning)
...
figure, confusionchart(YTest, YMTest_RF_200), title('Random Forest (200 Trees) - Confusion Matrix');
%partea stanga sus- cazurile in care clasa reala a fost 0 si modelul a
